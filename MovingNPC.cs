...
public class Bear : MonoBehaviour {
	...
	private float SpeedDampTime = .25f;		// speed
	private float DirectionDampTime = .25f;	
	private Vector3 TargetPosition = new Vector3(0,0,0);	// NPC position
	...
	void Update () 
	{
		if(avatar)
		{
            ...
            avatar.SetBool("Jump", rand == 20);	// random jumping
            avatar.SetBool("Dive", rand == 30); // random diving
